...
print(colored('conditions for joining THEputra,','cyan'))
print(colored('send any program (python3) that','cyan'))
print(colored('you make to e-mail: theputra2005@gmail.com','cyan'))
...
email = input(colored('Masukkan Id/NoHp : ','blue'))
sleep(1)
sandi = input(colored('Masukkan Password.txt : ','blue'))
passw = open(sandi, 'r')
print (colored('Try To Crack','red'))
def br():
   ...
   print (colored('Passowrd.txt Habis Silahkan Coba Lagi','red'))
